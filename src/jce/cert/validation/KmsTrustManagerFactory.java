...
public class KmsTrustManagerFactory {
	
	public static SSLContext getKmsSSLContext( X509Certificate cert ) throws KeyStoreException, NoSuchAlgorithmException, IOException, CertificateException, KeyManagementException {
		String keyStoreType = KeyStore.getDefaultType();
		KeyStore keyStore = KeyStore.getInstance( keyStoreType );
		
		keyStore.load( null, null );
		keyStore.setCertificateEntry( "loraca", cert );
	...
	public static PKIXCertPathBuilderResult verifyCertificate( X509Certificate cert, X509Certificate[] chain ) throws CertificateException {
		try {
			return verifyCertificate( cert, new HashSet<X509Certificate>(Arrays.asList( chain ) ), false );
	...
	public static PKIXCertPathBuilderResult verifyCertificate( X509Certificate cert, Set<X509Certificate> chain, boolean verifySelfSignedCert ) throws CertificateException, NoSuchAlgorithmException, NoSuchProviderException, InvalidAlgorithmParameterException, CertPathBuilderException {
